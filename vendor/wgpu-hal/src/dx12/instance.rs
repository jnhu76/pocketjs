...
impl crate::Instance for super::Instance {
    ...
    unsafe fn enumerate_adapters(
        ...
        // AUDIT-ONLY markers (E50a/E50b): DXGI factory enumeration seam.
        crate::norm_hook::norm_mark("E50a_DXGI_ENUM_BEGIN");
        ...
        let exposed = adapters
            ...
            .collect();
        crate::norm_hook::norm_mark("E50d_ADAPTER_EXPOSE_END");
        exposed
    }
}
