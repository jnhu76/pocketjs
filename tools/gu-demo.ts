...
// PNGs for eyeballing. The 3D-backend equivalent of tests/e2e/ppsspp.ts's
// build+run half, without goldens — this is a bring-up/debug tool.
//
//   bun tools/gu-demo.ts                        # de_dust2, frames 8..40
//   bun tools/gu-demo.ts --map de_inferno --cap-start 0 --cap-n 480
//   POCKET3D_TEST_MAPS=~/cs bun tools/gu-demo.ts
//
...
// ---- 2. cargo psp (same canonical contract as tools/psp.ts) ----------
